...
%>
	...
	<table>
		...
		<tr>
			...
			<input type="text" size="10" maxlength="10" name="writer" style="ime-mode:active;"></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td width="330" align="left">
			<input type="text" size="40" maxlength="30"name="email" value="<%=strV%>" style="ime-mode:inactive;">
			</td>
		</tr>
		<tr>
			<td width="70" align="center" bgcolor="<%=value_c%>">내용</td>
			<td width="330" align="left">
			<textarea name="content" rows="13" cols="40" style="ime-mode:active;" ></textarea><!-- 한글로 -->
			</td>
		</tr>
		<tr>
			<td width="70" align="center" bgcolor="<%=value_c%>">비밀번호</td>
			<td width="330" align="left">
			<input type="password" size="8" maxlength="12"name="passwd" style="ime-mode:inactive;"><!-- 영어로 -->
			</td>
		</tr>
		<tr>
